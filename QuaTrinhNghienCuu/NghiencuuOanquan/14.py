    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            def hien_thi_diem():
                ...
                score_surface_n1 = game_font.render(f'Score Player 1: {scored_01}', True, (0, 0, 0))
                score_surface_n2 = game_font.render(f'Score_Player_2: {scored_02}', True, (0, 0, 0))
                score_rect_n2 = score_surface_n2.get_rect(center=(200, 40))
                score_rect_n1 = score_surface_n1.get_rect(center=(200, 650))
